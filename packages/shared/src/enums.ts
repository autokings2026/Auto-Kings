...
export enum TipoEventoOT {
  ...
  COTIZACION_ADICIONAL_GENERADA = 'COTIZACION_ADICIONAL_GENERADA',
  COTIZACION_ADICIONAL_ENVIADA_WA = 'COTIZACION_ADICIONAL_ENVIADA_WA',
  COTIZACION_ADICIONAL_APROBADA = 'COTIZACION_ADICIONAL_APROBADA',
  COTIZACION_ADICIONAL_RECHAZADA = 'COTIZACION_ADICIONAL_RECHAZADA',
